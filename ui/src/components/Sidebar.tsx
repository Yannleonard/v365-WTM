...
const GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: "/alarms", label: "Alarms", icon: <IconAlert size={18} />, perms: ["alarms.read"] },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/resource-pools", label: "Resource Pools", icon: <IconScale size={18} />, perms: ["vm.read"] },
      ...
      { to: "/vm-backups", label: "VM Backups", icon: <IconDownload size={18} />, perms: ["vm.backup"] },
    ],
  },
  {
    label: "Storage",
