...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/vm-networks", label: "Networks", icon: <IconNetworks size={18} />, perms: ["vm.network.read", "vm.network.write", "vm.read"] },
      { to: "/vm-storage", label: "Storage", icon: <IconVolumes size={18} />, perms: ["vm.storage.read", "vm.storage.write", "vm.read"] },
