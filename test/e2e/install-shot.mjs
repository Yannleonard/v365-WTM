...
const VM=process.argv[2]||'linux-server';
...
await page.waitForTimeout(8000); // let OS boot + guacamole draw
await page.screenshot({path:`/work/test/e2e/shots/install-${VM}.png`, fullPage:true});
console.log(VM+' canvas:', await page.locator('canvas').count());
